...
public class Order implements Serializable {
    ...
    /**
     * 订单状态 1：新订单 2：已下发 3：维修中 4：维修完成 5：质检中 6：质检完成 7：结算中 8：完成
     */
    ...
    public static final String ORDER_STATE_SETTLEMENT = "7";
    public static final String ORDER_STATE_DONE = "8";
    ...
    public String getStateName() {
        ...
        if(getState().equals(ORDER_STATE_NEW)) {
            ...
            return "质检中";
        }else if(getState().equals(ORDER_STATE_CHECKED)){
            return "质检完成";
